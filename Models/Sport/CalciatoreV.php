...
class CalciatoreV extends Table {
    
    // Nome della tabella
    const TABLE_NAME = "calciatore_v";
    const BINDINGS = [
    ...
    public $allenatore = null;
    public $denominazione = null;
    public $datafondazione = null;
    ...
    public function save(){
     ...
     public function loadSquadra() {
        try {
            $sql = "SELECT id, allenatore FROM squadra WHERE id = :id ORDER BY id";
